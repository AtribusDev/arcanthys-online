// Default to dark mode regardless of OS/browser color-scheme preference.
// An explicit user choice (saved via the toggle) always takes precedence.
...
const setupDarkmode = () => {
  ...
  const currentSavedTheme =
    (document.documentElement.getAttribute("saved-theme") as "light" | "dark") ?? "dark";
